...
word_emb_file = "word_emb{}.json".format('_hops' if hops else '')
char_emb_file = "char_emb{}.json".format('_hops' if hops else '')
train_eval = "train_eval{}.json".format('_hops' if hops else '')
dev_eval = "dev_eval{}.json".format('_hops' if hops else '')
test_eval = "test_eval{}.json".format('_hops' if hops else '')
word2idx_file = "word2idx{}.json".format('_hops' if hops else '')
char2idx_file = "char2idx{}.json".format('_hops' if hops else '')
idx2word_file = 'idx2word{}.json'.format('_hops' if hops else '')
idx2char_file = 'idx2char{}.json'.format('_hops' if hops else '')
train_record_file = 'train_record{}.pkl'.format('_hops' if hops else '')
dev_record_file = 'dev_record{}.pkl'.format('_hops' if hops else '')
test_record_file = 'test_record{}.pkl'.format('_hops' if hops else '')
...
parser.add_argument('--no-cuda', dest='cuda', default=torch.cuda.is_available(), action='store_false')
