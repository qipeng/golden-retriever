# BiDAF++ variant used for GoldEn Retriever

This repository contains the QA component of GoldEn retriever, which is adapted from the [HotpotQA baseline model](https://github.com/hotpotqa/hotpot).

## Requirements

Python 3, pytorch 1.1.0, stanfordnlp

To install pytorch 1.1.0, follow the instructions at https://pytorch.org/get-started/previous-versions/ . For example, with
CUDA9 and conda you can do
```
conda install pytorch=1.1.0 cuda90 -c pytorch
```

To install stanfordnlp, run
```
...
Run the script to download the data, including HotpotQA data and GloVe embeddings.
```
./download.sh
```
Please follow the instructions [here](https://stanfordnlp.github.io/stanfordnlp/corenlp_client.html#setup) to setup CoreNLP for tokenization.
